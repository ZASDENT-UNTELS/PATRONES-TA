...
// La ruta del autoload de composer asume que estamos en php/service/ y sube 2 niveles a la raíz
...
class CorreoService
{
    ...
    public function enviarConfirmacionCita(string $destinatario, string $nombrePaciente, array $datosCita): bool
    {
        try {
            ...
            return false; // Silencioso para que no rompa la creación de la cita, pero registrado en el log
        }
    }
}
