...
class CitaDTO
{
    public function __construct(
        // ── Identificadores ───────────────────────────────────────────────
        public readonly ?int    $id                  = null,  // null al crear, int al leer
        ...
        // ── Datos de la cita ──────────────────────────────────────────────
        public readonly ?string $fechaHora           = null,  // 'YYYY-MM-DD HH:MM:SS'
        public readonly int     $duracion            = 30,    // minutos
        public readonly string  $estado              = 'Pendiente', // Pendiente|Confirmada|Cancelada|Completada
        public readonly ?string $notas               = null,
        public readonly int     $recordatorioEnviado = 0,
    ) {}
     ...
     *
     * Uso:
     *   $dto = CitaDTO::fromArray($request_data);
