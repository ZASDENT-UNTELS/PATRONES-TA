    ...
    public function findById(int $id): ?array
    {
        $stmt = $this->conn->prepare('
            SELECT u.*, r.nombre AS nombre_rol,
                   p.fecha_nacimiento, p.genero, p.alergias, p.enfermedades_cronicas, p.seguro_medico, p.numero_seguro,
                   d.id_especialidad, d.cedula_profesional, d.biografia, d.experiencia, d.horario, d.foto
            FROM usuarios u
            LEFT JOIN roles r ON u.id_rol = r.id_rol
            LEFT JOIN pacientes p ON u.id_usuario = p.id_usuario
            LEFT JOIN dentistas d ON u.id_usuario = d.id_usuario
